...
//			echo 'inserting or updating project data';
			...
			if(empty($_POST['sitesign']) | empty($_POST['ppe']) | empty($_POST['hns']) | empty($_POST['firstaid']) | 			empty($_POST['siltfence']) | empty($_POST['security'])  | empty($_POST['scaffolding']) | empty($_POST['fallin']) | empty($_POST['sfcomment'])){
...
<!--				 <input type="checkbox" data-toggle="toggle" unchecked data-on="Yes" data-off="No" data-width="100">		-->
					 ...
					 <label class="col-5">PPE Allowance</label>
						<div class="form-check form-check-inline">
							<label class="form-check-label">
								<input class="form-check-input" type="radio" name="ppe" id="ppe" value="Yes" <?php if(isset($safetyreqRS['ppe_allowance']) && $safetyreqRS['ppe_allowance']=='Yes'){ ?> checked <?php } ?> >
								 Yes  
							</label>
						  </div>
						  <div class="form-check form-check-inline">
