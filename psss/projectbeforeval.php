...
<!--		 <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css">-->
	...
	<body>
		...
		<div class="topnav" id="myTopnav">
			<a class="dropdown active dropdown-toggle" data-toggle="dropdown">Project</a>
			<div class="dropdown-menu">
				<a class="dropdown-item active" data-toggle="modal" href="#roomoption">Room</a>
				<a class="dropdown-item active" data-toggle="modal" href="#extoption">Exterior</a>
			</div>
		...
		<form action="project.php" method="POST" name="proform">
		<div id="accordion">
			...
			<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
			  <div class="card-body">
				 ...
				 <span class="form-group has-float-label">
					...
					<textarea data-autoresize class="form-control" rows="1" id="comment" name="comment" placeholder=" " value="<?php if(isset($siteArrRS['comment'])) echo $siteArrRS['comment']; ?>"></textarea>
					  <label>Comment</label>
					  </span>
...
<!--				 <input type="checkbox" data-toggle="toggle" unchecked data-on="Yes" data-off="No" data-width="100">		-->
					 	<div class="form-check form-check-inline">
							<label class="form-check-label">
								<input  type="radio" name="sitesign" id="sitesign1" value="Yes"  <?php if(isset($safetyreqRS['site_sign']) && $safetyreqRS['site_sign']=='Yes'){ ?> checked <?php } ?>>
								 Yes  
							</label>
						  </div>
						  <div class="form-check form-check-inline">
							<label class="form-check-label form-check-inline">
								<input type="radio" name="sitesign" id="sitesign2" value="No" <?php if(isset($safetyreqRS['site_sign']) && $safetyreqRS['site_sign']=='No'){ ?> checked <?php } ?> >
								 No  
							</label>
						  </div>
						 </div>
					 ...
					 <label class="col-5">PPE Allowance</label>
						<div class="form-check form-check-inline">
							<label class="form-check-label">
								<input class="form-check-input" type="radio" name="ppe" id="exampleRadios3" value="Yes" <?php if(isset($safetyreqRS['ppe_allowance']) && $safetyreqRS['ppe_allowance']=='Yes'){ ?> checked <?php } ?> >
								 Yes  
							</label>
						  </div>
						  <div class="form-check form-check-inline">
							<label class="form-check-label form-check-inline">
								<input class="form-check-input" type="radio" name="ppe" id="exampleRadios4" value="No" <?php if(isset($safetyreqRS['ppe_allowance']) && $safetyreqRS['ppe_allowance']=='No'){ ?> checked <?php } ?>>
								 No  
							</label>
						  </div>
					 <br />
					 <label class="col-5">H & S System</label>
						<div class="form-check form-check-inline">
							<label class="form-check-label">
								<input class="form-check-input" type="radio" name="hns" id="exampleRadios5" value="Yes" <?php if(isset($safetyreqRS['h_&_s_system']) && $safetyreqRS['h_&_s_system']=='Yes'){ ?> checked <?php } ?>>
								 Yes  
							</label>
						  </div>
						  <div class="form-check form-check-inline">
					 ...
					 <label class="col-5">Silt Fence</label>
					  ...
					  <span class="form-group has-float-label">
					   ...
					   <span class="form-group has-float-label">
						<textarea data-autoresize class="form-control"  rows="1" name="sfcomment" placeholder=" " value="<?php if(isset($safetyreqRS['comment'])) echo $safetyreqRS['comment']; ?>"></textarea>
			...
			<div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion">
			  <div class="card-body">
					<span class="form-group has-float-label">
						<input class="form-control" type="text" id="input1" name="builder" placeholder=" " value="<?php if(isset($ppRS['no_builders'])) echo $ppRS['no_builders'];  ?>"/>
						<label>No builders</label>
					  </span>
					
					<span class="form-group has-float-label">
						<input class="form-control" type="text" id="input2" name="bhour" placeholder=" " value="<?php if(isset($ppRS['builder_hourly_rate'])) echo $ppRS['builder_hourly_rate'];  ?>"/>
						<label>Builder hourly rate</label>
					  </span>
					<span class="form-group has-float-label">
						<input class="form-control" type="text" id="input3" name="supervision" placeholder=" " value="<?php if(isset($ppRS['supervision'])) echo $ppRS['supervision'];  ?>"/>
						<label>Supervision Hours Per Week</label>
					  </span>
					<span class="form-group has-float-label">
						<input class="form-control" type="text" id="input4" name="shour" placeholder=" " value="<?php if(isset($ppRS['supervision_hourly_rate'])) echo $ppRS['supervision_hourly_rate'];  ?>"/>
						<label>Supervision Hourly Rate</label>
					  </span>
					<span class="form-group has-float-label">
						<input class="form-control" type="text" id="input5" name="adminisration" placeholder=" " value="<?php if(isset($ppRS['adminisration'])) echo $ppRS['adminisration'];  ?>"/>
						<label>Administration Hours Per Week</label>
					  </span>
					<span class="form-group has-float-label">
						<input class="form-control" type="text" id="input6" name="ahour" placeholder=" " value="<?php if(isset($ppRS['administration_hourly_rate'])) echo $ppRS['administration_hourly_rate'];  ?>"/>
						<label>Administration Hourly Rate</label>
					  </span>
					<span class="form-group has-float-label">
						<input class="form-control" type="text" id="input7" name="travel" placeholder=" " value="<?php if(isset($ppRS['travel_distance'])) echo $ppRS['travel_distance'];  ?>"/>
						<label>Travel Distance</label>
					  </span>
					<span class="form-group has-float-label">
						<input class="form-control" type="text" id="input8" name="trate" placeholder=" " value="<?php if(isset($ppRS['travel_km_rate'])) echo $ppRS['travel_km_rate'];  ?>"/>
			...
			<div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordion">
			  <div class="card-body">
				  ...
				  <span class="form-group has-float-label">
						<input class="form-control" type="text" id="labour" name="labour" placeholder=" "  value="<?php if(isset($markupRS['labour'])) echo $markupRS['labour'];  ?>"/>
						<label>Labour</label>
					  </span>
					
						<span class="form-group has-float-label">
						<input class="form-control" type="text" id="materials" name="materials" placeholder=" "  value="<?php if(isset($markupRS['materials'])) echo $markupRS['materials'];  ?>"/>
						<label>Materials</label>
					  </span>
					
					<span class="form-group has-float-label">
						<input class="form-control" type="text" id="subcontractors" name="subcontractors" placeholder=" "  value="<?php if(isset($markupRS['subcontractors'])) echo $markupRS['subcontractors'];  ?>"/>
						<label>Subcontractors</label>
					  </span>
					<span class="form-group has-float-label">
						<textarea data-autoresize class="form-control"  rows="1" id="comment" name="markupcomment" placeholder=" "  value="<?php if(isset($markupRS['comment'])) echo $markupRS['comment'];  ?>"></textarea>
						<label>Comment</label>
					  </span>
			  </div>
			</div>
			...
			<div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordion">
			  <div class="card-body">
						<span class="form-group has-float-label">
						<input class="form-control" type="text" id="input1" name="pduration" placeholder=" " value="<?php if(isset($allowancesInsRS['estimated_project_duration'])) echo $allowancesInsRS['estimated_project_duration'];  ?>"/>
					...
					<span class="form-group has-float-label">
						<input class="form-control" type="text" id="input4" name="pvalue" placeholder=" " value="<?php if(isset($allowancesInsRS['approx_project_value'])) echo $allowancesInsRS['approx_project_value'];  ?>"/>
						<label>Expected Project Value</label>
					  </span>
					<span class="form-group has-float-label">
						<input class="form-control" type="text" id="input5" name="acost" placeholder=" " value="<?php if(isset($allowancesInsRS['administration_costs'])) echo $allowancesInsRS['administration_costs'];  ?>"/>
			...
			<div id="collapseSeven" class="collapse" aria-labelledby="headingSeven" data-parent="#accordion">
			  <div class="card-body">
				   ...
				   <label class="col-5">Plans</label>
						  ...
						  <div class="form-check form-check-inline">
							<label class="form-check-label form-check-inline">
								<input class="form-check-input" type="radio" name="plans" id="plans" value="No" <?php if(isset($proservRS['plans']) && $proservRS['plans']=='No'){ ?> checked <?php } ?>>
								 No  
							</label>
						  </div>
				  <br />
